...
import img from "@/assets/Images/clients/Vector.png"
      ...
      <div className="flex  justify-center items-center gap-4 px-3 lg:gap-6 h-72 bg-linear-to-r from-[#17393F] via-[#2C4E4B] to-[#5D7C60] my-20">
        {/* {certificates.map((img, index) => (
          <div
            ...
            className={`w-64 h-50 md:h-96 transition-all duration-500 cursor-pointer ${
              active === index ? "scale-110 z-10" : "scale-90 "
            }`}
          >
        ...
        <div>
          <div className="  bg-no-repeat bg-cover" style={{ backgroundImage: `url(${img})` }}>bggg</div>
        </div>
      </div>
    </>
  );
