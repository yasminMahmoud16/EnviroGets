...
import {consulting1,consulting2,consulting3,consulting4} from "@/assets/Images/Images.js";
    ...
    <>
      <div className="px-8 flex flex-col ">
        <TitleSec
          ...
          className="text-main font-normal text-2xl! md:text-3xl! my-4"
        />

        <div className="flex  ">
          {/* list */}
          <ul
            className={`md:list-inside pb-4 pr-3 text-main text-justify ${isArabic ? "font-bold text-base md:text-xl" : "font-roboto font-normal md:text-sm lg:text-lg"}`}
